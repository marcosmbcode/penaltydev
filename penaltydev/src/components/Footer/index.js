...
const Footer = () => (
    ...
    <footer className="footer"><div className="benefits-bar">
        ...
        <div className="footer__nav"><div className="footer__grid">
            <div className="footer__col footer__social"><div className="footer__logo pnty-logo-1">Penalty</div><h4 className="footer__subtitle">Siga a Penalty</h4><p className="footer__text">Onde tem Penalty, tem liga!</p><ul className="footer__social-list"><li className="footer__social-item footer__social-item--facebook"><a className="footer__social-link" href="https://www.facebook.com/penaltybr" target="_blank" rel="noopener"><i className="icon-facebook" /><span className="footer__social-text">Facebook</span></a></li><li className="footer__social-item footer__social-item--instagram"><a className="footer__social-link" href="https://www.instagram.com/penaltybr" target="_blank" rel="noopener"><i className="icon-instagram" /><span className="footer__social-text">Instagram</span></a></li><li className="footer__social-item footer__social-item--youtube"><a className="footer__social-link" href="https://www.youtube.com/user/PenaltyBR/videos" target="_blank" rel="noopener"><i className="icon-youtube" /><span className="footer__social-text">Youtube</span></a></li><li className="footer__social-item footer__social-item--twitter"><a className="footer__social-link" href="https://twitter.com/penaltybr" target="_blank" rel="noopener"><i className="icon-twitter" /><span className="footer__social-text">Twitter</span></a></li><li className="footer__social-item footer__social-item--linkedin"><a className="footer__social-link" href="https://www.linkedin.com/company/cambucisa/" target="_blank" rel="noopener"><i className="icon-linkedin" /><span className="footer__social-text">Linkedin</span></a></li></ul></div><div className="footer__col footer__institutional footer__col--accordion"><button className="footer__button-accordion">Abrir</button><h4 className="footer__title">Institucional</h4><ul className="footer__list"><li className="footer__list-item"><a href="/institucional/quem-somos">Quem Somos</a></li><li className="footer__list-item"><a href="/institucional/trabalhe-conosco">Trabalhe Conosco</a></li><li className="footer__list-item"><a href="/universidade-penalty">Universidade Penalty</a></li><li className="footer__list-item"><a href="/institucional/penalty-internacional">Penalty Internacional</a></li><li className="footer__list-item"><a href="/lojas">Nossas Lojas</a></li><li className="footer__list-item"><a href="http://www.cambuci.com.br/" target="_blank" rel="noopener">Cambuci SA</a></li></ul></div><div className="footer__col footer__contact footer__col--accordion"><button className="footer__button-accordion">Abrir</button><h4 className="footer__title">Atendimento</h4><ul className="footer__list"><li className="footer__list-item"><a href="/_secure/minha-conta#/orders">Acompanhar meus Pedidos</a></li><li className="footer__list-item"><a href="https://penalty.zendesk.com/hc/pt-br" target="_blank">Perguntas Frequentes</a></li><li className="footer__list-item"><a href="https://penalty.zendesk.com/hc/pt-br/articles/360046347011-Politica-de-Troca-e-Devolu%C3%A7%C3%A3o" target="_blank">Trocas e Devoluções</a></li><li className="footer__list-item"><a href="https://penalty.zendesk.com/hc/pt-br/articles/360046372891-Pol%C3%ADtica-de-Privacidade-e-Seguran%C3%A7a" target="_blank">Política de Privacidade</a></li><li className="footer__list-item"><a href="https://penalty.zendesk.com/hc/pt-br/articles/360048458252-Pol%C3%ADtica-de-Pagamento" target="_blank">Formas de Pagamento</a></li><li className="footer__list-item"><a href="/atendimento-corporativo">Atendimento Corporativo</a></li></ul></div><div className="footer__col footer__payment"><h4 className="footer__title">Formas de pagamento</h4><p className="footer__description">Parcele em até <b>10x sem juros*</b></p><div className="footer__payment-methods"><p>Visa | MasterCard | American Express | Elo | Hipercard | Boleto</p></div></div><div className="footer__col footer__security">
            ...
            <ul className="footer__security-list">
                <li className="footer__security-item footer__security-item--nbb">
                    <a href="https://lnb.com.br/" target="_blank" rel="noopener">
                ...
                <li className="footer__security-item footer__security-item--cbfs">
                    <a href="https://www.cbfs.com.br/" target="_blank" rel="noopener">
